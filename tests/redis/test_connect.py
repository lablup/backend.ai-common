...
async def test_instantiate_redisconninfo() -> None:
    ...
    assert isinstance(r1.client, redis.asyncio.Sentinel)
    ...
    assert isinstance(r2.client, redis.asyncio.Sentinel)
...
async def test_connect_cluster_sentinel(redis_cluster: RedisClusterInfo) -> None:
    ...
    async with aiotools.TaskGroup() as tg:
        ...
        for _ in range(5):
            ...
            except redis.asyncio.sentinel.MasterNotFoundError:
            ...
            try:
                ...
                await slave.ping()
            except redis.asyncio.sentinel.SlaveNotFoundError:
